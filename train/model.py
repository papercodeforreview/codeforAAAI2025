...
class DrugEncoder(torch.nn.Module):
    def __init__(self, in_dim, edge_in_dim, hidden_dim=64, n_iter=5):
        super().__init__()
...
class causalI(torch.nn.Module):
    def __init__(self, in_dim, edge_in_dim, hidden_dim=256, n_iter=10):
        super(SA_DDI, self).__init__()

        self.sat = GraphTransformer(in_dim, hidden_dim)
